                ...
                <div className="Helpcenter-section">
                    ...
                    <div className="Helpcenter-layout">
                        ...
                        <div className="Helpcenter-sidebar">
                            ...
                            {openIndex === 0 && (
                                <div className="helpcenter-submenu">
                                    <Link to='/Job-portal-Live/jobseeker/help-center/profile-creation-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Profile creation</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/resume-upload-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Resume upload</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/job-apply-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Job apply issues</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/interview-scheduling-help' className="helpcenter-submenu-link" >
                            ...
                            {openIndex === 1 && (
                                <div className="helpcenter-submenu">
                                    <Link to='/Job-portal-Live/jobseeker/help-center/job-posting-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Job posting</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/candidate-search-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Candidate search</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/subscription-issue-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Subscription issues</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/invoice-payment-help' className="helpcenter-submenu-link" >
                            ...
                            {openIndex === 2 && (
                                <div className="helpcenter-submenu">
                                    <Link to='/Job-portal-Live/jobseeker/help-center/login-issue-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Login issues</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/page-error-help' className="helpcenter-submenu-link" >
                                        <div className="helpcenter-submenu-item">Page errors</div>
                                    </Link>
                                    <Link to='/Job-portal-Live/jobseeker/help-center/file-upload-help' className="helpcenter-submenu-link" >
                        ...
                        <div className="helpcenter-support-options">
                            <Link to='/Job-portal-Live/jobseeker/help-center/help-FAQs' className="helpcenter-support-item" ><div >Popular Articles / FAQs</div></Link>
                            <Link to='/Job-portal-Live/jobseeker/help-center/raise-a-ticket' className="helpcenter-support-item" ><div >Raise a Ticket</div></Link>
                            <Link to='/Job-portal-Live/jobseeker/help-center/live-chat' className="helpcenter-support-item" ><div >Live Chat</div></Link>
